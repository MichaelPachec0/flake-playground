...
}:
{
  base46 = {
    pname = "base46";
    version = "7df2bd89295db00b649cbc49bdf6fe5a1cc5df3b";
    src = fetchFromGitHub {
      owner = "NvChad";
      repo = "base46";
      rev = "7df2bd89295db00b649cbc49bdf6fe5a1cc5df3b";
      fetchSubmodules = false;
      sha256 = "sha256-LIYAurLRSHnGtDUvxUvIE0PJ1cZ6L0M4nQ+a1H2SgJg=";
    };
    date = "2026-09-25";
  };
  blockNvim = {
  ...
  kittyScrollback = {
    ...
    version = "4994c85e0f291598d0748488653c83cb698fd281";
    src = fetchgit {
      url = "https://github.com/mikesmithgh/kitty-scrollback.nvim";
      rev = "4994c85e0f291598d0748488653c83cb698fd281";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
